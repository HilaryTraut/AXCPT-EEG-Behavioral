...
#
# Notes: Behavioral version. Images courtesy Lucenet & Blaye. Search
#        '!!!' for updating call to trial list .csv files.
######################################################################
...
rowlist = ["part_id", "dob", "age_group", "runner", "date", "block", "trial", "cond", "cue", "probe", \
               "resp", "acc", "cueStart", "cueEnd", "delayStart", "delayEnd", "probeStart", "probeEnd", "rt"]        #Write headers

rowformat = "{:18}"*(len(rowlist))

header = "part_id" + ","+ "dob" + ", "+ "age_group" + ","+ "runner" + "," + "date" + "," + "block" + "," + "trial" + "," + "cond" + "," + "cue" + "," + "probe" \
               + "," + "resp" + "," + "acc" + "," + "cueStart" + "," + "cueEnd" + "," + "delayStart" + "," + "delayEnd" + "," + "probeStart" + "," + "probeEnd" + "," + "rt"
